...
namespace FrancisStore.Identity.Controllers
{
    ...
    {
        private FrancisStoreSignInManager _signInManager;
        private FrancisStoreUserManager _userManager;
        ...
        public AccountController(FrancisStoreSignInManager signInManager, FrancisStoreUserManager userManager, IShoppingCartService shoppingcartService)
        {
        ...
        public FrancisStoreSignInManager SignInManager
        {
            get
            {
                return _signInManager ?? HttpContext.GetOwinContext().Get<FrancisStoreSignInManager>();
            }
            private set 
            { 
        ...
        public FrancisStoreUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<FrancisStoreUserManager>();
            }
            private set
            {
                _userManager = value;
