...
namespace FrancisStore.Service.Products.Interfaces
{
    ...
    {
        Task<IList<Product>> GetPagedProductListAsync(string searchString = null, int page = 1, int pageSize = 50);
        Task<int> CountAsync(string searchString = null);
        Task<IList<Product>> GetPagedProductListByCollectionIdAsync(long id, string searchString = null, int page = 1, int pageSize = 50);
